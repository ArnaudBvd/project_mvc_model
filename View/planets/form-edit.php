...
<div class="container mb-5">
    ...
    <form method="post" class="row mt-4">
        ...
        <div class="col-md-12 mb-3">
            ...
            <input type="text" name="name" id="name" value="<?php echo($planet->getName()) ?>" class="form-control
        ...
        <div class="col-md-12 mb-3">
            ...
            <textarea name="description" class="form-control" id="description"><?php echo($planet->getDescription());?>
            </textarea>
        </div>
        ...
        <div class="col-md-12 mb-3">
            ...
            <input type="text" name="picture" value="<?php echo($planet->getPicture())?>" id="picture" class="form-control
